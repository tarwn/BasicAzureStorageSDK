...
{
    /// <summary>
    /// Lease Container - Only the Renew Lease action
    ...
    /// </remarks>
    public class LeaseContainerRenewRequest : RequestBase<LeaseContainerRenewResponse>, ISendAdditionalOptionalHeaders
    {
